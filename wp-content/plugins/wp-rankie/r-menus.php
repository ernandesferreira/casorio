...
function wp_ranker_control_menu() {
	...
	add_menu_page( 'WP Rankie', 'WP Rankie', 'administrator', 'wp_rankie', 'wp_rankie_dashboard_fn', 'dashicons-chart-area', 77777788877777 );
	$dashboardSlug=add_submenu_page( 'wp_rankie',  'Wordpress Rankie','Dashboard', 'administrator', 'wp_rankie', 'wp_rankie_dashboard_fn' );
	$reportsSlug = add_submenu_page( 'wp_rankie', 'Wordpress Rankie Reports', 'Reports', 'administrator', 'wp_rankie_reports', 'wp_rankie_reports_fn' );
	$researchSlug = add_submenu_page( 'wp_rankie', 'Wordpress Rankie Keyword Research', 'Research', 'administrator', 'wp_rankie_research', 'wp_rankie_research' );
