				...
				<div class="inside">
					<table class="form-table">
						<tbody>
							...
							<tr class="google_selector googledirect">
								
								<th scope="row"><label> Auto proxify Google requests ? [Beta]   </label></th>
								...
								<td>
						 			...
						 			<div  class="field f_100" >
						 			     <div class="option clearfix">
						 			         ...
						 			         <input     name="wp_rankie_options[]"  value="OPT_AUTO_PROXYFY" type="checkbox">
						 			         <label>Tick this option for the plugin to call Google via a proxy</label>     
						 			     </div>
						 			</div> 
