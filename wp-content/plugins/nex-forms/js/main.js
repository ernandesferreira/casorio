	...
	$(window).load
		...
		function()
			...
			$('#preloader').delay(100).fadeOut('fast', 
				function()
					{ 
					jQuery('.show_welcome_message').delay(500).trigger('click'); 
					}
				);
