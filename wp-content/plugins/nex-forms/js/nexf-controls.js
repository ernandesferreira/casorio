...
jQuery('.create_new_calendar').live('click',
		function()
			{
			if(!jQuery('input[name="new_calendar_title"]').val())
				{
				jQuery('input[name="new_calendar_title"]').popover({trigger:'manual'});
				jQuery('input[name="new_calendar_title"]').popover('show');
				jQuery('input[name="new_calendar_title"]').parent().find('.popover ').addClass('alert-info');
				jQuery('input[name="new_calendar_title"]').focus();
			...
			var data =
				...
				action	 						: 'do_insert',
				table							: 'wap_nex_forms',
				title							: jQuery('input[name="new_calendar_title"]').val(),
				description						: jQuery('input[name="new_calendar_description"]').val(),
...
jQuery('a.visible_form_title').click(
	...
	jQuery('.form_canvas').click(
		function()
			...
			jQuery('div.nex-forms-container, .view_settings').show();
			}
		);
	jQuery('.on_submit').click(
		function()
			...
			if(jQuery('.nex-forms-field-settings').hasClass('open'))
				jQuery('div.nex-forms-field-settings .close').trigger('click');
			jQuery('div#collapseFormsCanvas .panel-body.panel_view, .view_settings').hide();
