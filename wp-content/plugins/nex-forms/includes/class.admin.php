...
//TAG SETTINGS												
	...
	public function NEXForms_Admin(){
		...
		//Welcome Message
		$output .= '<div id="nex-forms"><div class="modal fade" id="welcomeMessage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		//Edit Calendar
		$output .= '<div class="modal fade" id="editCalendar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						  <div class="modal-dialog">
							<div class="modal-content">
		...
		//Calendar Settings				
		$output .= '<div class="modal fade" id="calendarSettings" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						  <div class="modal-dialog">
							<div class="modal-content">
		...
		//Use Calendar
		$output .= '<div class="modal fade" id="useCalendar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						  <div class="modal-dialog">
							<div class="modal-content">
							  <div class="modal-header alert alert-info">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		...
		//DELETE CONFIRM
		$output .= '<div class="modal fade" id="deleteCalendar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						  <div class="modal-dialog">
							<div class="modal-content">
						...
						//STAR RATING
							...
							//SLIDER
								...
								$output .= '<div class="field form_field extended-fields time">';
									$output .= '<div class="draggable_object input-group-sm">';
										$output .= '<div class="btn btn-success btn-sm form-control"><i class=" glyphicon glyphicon-time"></i>&nbsp;&nbsp;<span class="field_title">Time</span></div>';
									$output .= '</div>';
									$output .= '<div id="form_object" class="form_object" style="display:none;">';
											$output .= '<div class="input_holder no-pre-suffix">';
