...
/**************  ADMIN  ****************/
/***************************************/
if(is_admin() && ( isset($_GET['page']) && $_GET['page']=='nex-forms-main')){
/***************/
/*** WP Core ***/
/***************/
/* JS */
...
wp_enqueue_style('nex-forms-bootstrap-fields', WP_PLUGIN_URL . '/nex-forms/css/fields.css');
//nex-forms ADMIN
...
//FIELD SETTINGS
wp_enqueue_script('nex-forms-field-settings-main', WP_PLUGIN_URL . '/nex-forms/js/main.js');
//LOGIC
wp_enqueue_script('nex-forms-field-logic', WP_PLUGIN_URL . '/nex-forms/js/logic.js');
wp_print_scripts();
wp_print_styles();
}
?>